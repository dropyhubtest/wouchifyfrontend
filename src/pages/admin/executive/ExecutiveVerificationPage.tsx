...
export const ExecutiveVerificationPage: React.FC = () => {
  ...
  return (
    <ExecutiveLayout activeMenu="verification">
      <div className="executive-crud-page">
        ...
        <div className="crud-header" style={{ marginBottom: '20px' }}>
          <div>
            ...
            <h1 className="crud-title">Affiliate Link & Coupon Verification Suite</h1>
